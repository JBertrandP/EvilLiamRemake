...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x, y, speed, shoot_probability, bullets_group):
        ...
        self.bullets_group = bullets_group  # Referencia al grupo de balas enemigas
...
def main():
    ...
    enemy_bullets = pygame.sprite.Group()  # Grupo para balas enemigas
    enemy_group = pygame.sprite.Group()
    
    # Crear enemigos iniciales (pasando el grupo de balas enemigas)
    for _ in range(BASE_ENEMY_COUNT):
        enemy = Enemy(
            ...
            bullets_group=enemy_bullets  # Pasamos el grupo de balas
        )
    ...
    while running:
        ...
        player.update(keys)
        bullet_group.update()
        enemy_group.update()  # Esto ahora actualizará los disparos enemigos
        ...
        for bullet in bullet_group:
            ...
            for _ in enemies_hit:
                ...
                enemy = Enemy(
                    ...
                    enemy_bullets  # Pasamos el grupo de balas al nuevo enemigo
                )
                enemy_group.add(enemy)
        ...
        enemy_bullets.draw(screen)  # Dibujar balas enemigas
